      ...
      <div className="container about__container">
        ...
        <div className="about__content">
          ...
          <p>
            ...
            My name is Anh, pronounced as "Ah • ng" (Yes, like the Avatar!). Currently,  
            I am a fourth year CS student @NYU Courant with specific interests
            ...
            @NYU Steinhardt, which stems from my passion for Camera Collecting and Photography.
          </p>
